...
assert.match(customPrompt[0].content, /spoken_blocks/);
assert.match(customPrompt[0].content, /每个 spoken_blocks/);
assert.match(customPrompt[0].content, /短语级/);
...
assert.ok(editableViral.systemPrompt.includes('spoken_blocks'));
